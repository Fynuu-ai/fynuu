          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-slide-up">
              ...
              <div className="flex flex-wrap gap-4">
                <Button size="lg" className="bg-primary text-white hover:bg-primary/90 rounded-[7px] px-8 h-14 text-base font-medium transition-all duration-200" onClick={() => window.open('https://play.google.com/store/apps/details?id=io.smart.assistant', '_blank')}>
                ...
                <Button size="lg" variant="outline" className="bg-background border border-gray-300 text-foreground hover:bg-primary/5 hover:border-gray-400 rounded-[7px] px-8 h-14 text-base font-medium transition-all duration-200 cursor-not-allowed opacity-70" disabled>
                  <svg className="w-7.5 h-7.5 mr-2" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-warm animate-fade-in">
            <video className="w-full aspect-video" controls poster="/fynuu-logo.png">
              <source src="https://res.cloudinary.com/dgsi3q46q/video/upload/v1743857684/jtyzmns3sjfyvvz947ty.mp4" type="video/mp4" />
