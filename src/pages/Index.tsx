...
const Index = () => {
  ...
  return <div className="min-h-screen gradient-bg relative overflow-hidden">
    ...
    <section className="pt-20 pb-10 px-4 sm:px-6 lg:px-4">
          ...
          <div className="space-y-8 animate-slide-up">
            <div>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="gradient-text font-righteous">Meet fynuu</span>
                <span className="block text-foreground mt-2 font-righteous">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <Button
                size="lg"
                className="flex items-center justify-center bg-primary text-white hover:bg-primary/90 rounded-xl px-10 h-16 text-lg font-righteous transition-all duration-200 shadow-sm hover:shadow-md"
                onClick={() =>
                  window.open(
              ...
              <Button
                size="lg"
                variant="outline"
                className="flex items-center justify-center bg-background border border-gray-300 text-foreground hover:bg-primary/5 hover:border-gray-400 rounded-xl px-10 h-16 text-lg font-righteous transition-all duration-200 cursor-not-allowed opacity-70"
                onClick={() =>
                  window.open(
                    'https://docs.google.com/forms/d/e/1FAIpQLSeMcoIH5DJ0EBYDkQggphhHm4_3E8vecx7HfgfRzBgGdu1-Yg/viewform?usp=sharing&ouid=110908270479466534921',
                    '_blank'
                  )
                }
              >
